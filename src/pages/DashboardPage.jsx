      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {profileData?.user?.kycVerified
                    ...
                    : <Link to="/kyc" className="text-blue-600">Complete verification</Link>}
                </p>
              </div>
            </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:col-span-2">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/credentials" className="text-blue-600 hover:text-blue-700">
              View All
            </Link>
          </div>
          ...
          {credentialsData?.credentials?.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-2">
                <Link to="/kyc" className="text-blue-600 hover:text-blue-700">
