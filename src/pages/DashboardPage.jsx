    ...
    return (
      <div className="container mx-auto p-4">
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <p className="mb-6">You need to create a decentralized identity (DID) to get started.</p>
          <Link
            to="/identity/create"
    ...
    <div className="container mx-auto p-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:col-span-2">
          ...
          <div className="mb-4">
            <p className="text-gray-600">DID</p>
            <p className="font-mono text-sm break-all">{did || profileData?.user?.did}</p>
          </div>
          <div className="mb-4">
            <p className="text-gray-600">SBT Token ID</p>
            <p className="font-mono">{sbtTokenId}</p>
          </div>
          <div className="mb-4">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <div>
                <p className="font-semibold">Identity Created</p>
                <p className="text-sm text-gray-500">Your decentralized identity is active</p>
              </div>
            </div>
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {profileData?.user?.kycVerified 
                    ...
                    : <Link to="/kyc" className="text-primary-600">Complete verification</Link>}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="font-semibold">Verifiable Credentials</p>
                <p className="text-sm text-gray-500">
                  {credentialsData?.credentials?.length > 0 
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 md:col-span-2">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link to="/credentials" className="text-primary-600 hover:text-primary-700">
              View All
            </Link>
          </div>
          ...
          {credentialsData?.credentials?.length > 0 ? (
            <div className="space-y-4">
              {credentialsData.credentials.slice(0, 3).map(credential => (
                <div key={credential.credential_hash} className="border border-gray-200 rounded-lg p-4">
                  <div className="flex justify-between">
                    <p className="font-semibold">{credential.credential_type || 'Credential'}</p>
                  ...
                  <p className="text-sm text-gray-500 mt-1">Issued by: {credential.issuer_did}</p>
                  <p className="text-sm text-gray-500">
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-2">
                <Link to="/kyc" className="text-primary-600 hover:text-primary-700">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="space-y-3">
            <Link 
              to="/bridge" 
              className="block bg-gray-100 hover:bg-gray-200 p-3 rounded-lg"
            >
              <div className="flex items-center">
