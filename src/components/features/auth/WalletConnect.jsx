...
const WalletConnect = () => {
  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      // Get the challenge
      const chainName = chainId === 80002 ? 'polygon' : 'ethereum';
  ...
  return (
    <button
      ...
      className="bg-white text-primary-600 px-4 py-2 rounded-md hover:bg-gray-100 flex items-center"
    >
      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
        <path fillRule="evenodd" d="M4 4a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V6a2 2 0 00-2-2h-1.5l-1.8-1.8A2 2 0 0010.9 2H9.1a2 2 0 00-1.7.8L5.5 4H4zm7 5a1 1 0 00-1 1v1H9a1 1 0 100 2h1v1a1 1 0 102 0v-1h1a1 1 0 100-2h-1V9a1 1 0 00-1-1z" clipRule="evenodd" />
      </svg>
      Connect Wallet
    </button>
  );
